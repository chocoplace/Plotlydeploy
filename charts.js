...
// Deliverable 1: Horizonral Bar Chart 
...
// Deliverable 3: Create a Gauge Chart
    ...
    var metaFirstSample = metaArray[0];

    // 3. Create a variable that holds the washing frequency.
    var wasFreqs = metaFirstSample.wasFreq;
    console.log(wasFreqs)
    ...
    var gaugeData = [{
      ...
      gauge: {
        axis: { range: [null, 10], dtick: "2", tickcolor: "darkblue"},
        bar:  { color: "black"},
        steps: [
          {range: [0, 2], color: "red"},
